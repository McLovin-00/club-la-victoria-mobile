...
export default function SocioByDni() {
  ...
  useEffect(() => {
    const loadSocioData = async () => {
      try {
        ...
        logger.category('SocioByDni').debug('Socio cargado', {
        ...
        // ✅ Usa el sistema centralizado de manejo de errores
